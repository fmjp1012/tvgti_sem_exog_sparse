...
def main():
    ...
    print(filename)
    result_dir = create_result_dir(Path('./result'), 'exog_sparse_linear_mean', extra_tag='images')
    ...
    script_copies = {"run_linear_mean": str(backup_script(Path(__file__), scripts_dir))}
